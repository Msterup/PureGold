from monte_carlo_tree_search_n import MCTS
...
checkpoint = None # Path('checkpoints/2021-09-20T21-23-42/mario_net_2.chkpt')
...
for e in range(5000):
    ...
    while True:
        ...
        if all_same == True:
            ...
            #writer.add_scalar("Prediction mean of last 1000", torch.FloatTensor([st.mean(prediction_list_moving)]), cards_trained)
